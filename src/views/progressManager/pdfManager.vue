...
import {changeDoc, docType, findDoc, getSite, insertDoc, toPdfFile, listFolder, getFolderInfoTask, addFolder, getFolderContent, delFile } from "@/api/dataManage";
...
export default {
  ...
  methods: {
    ...
    handleNodeClick2() {},
    getFolderList(id) {
      var taskId = this.$store.state.nodeStateId
        getFolderInfoTask(this.constructionSiteId, parseInt(id), taskId).then((res) => {
