        ...
        <div class="dm-main">
          ...
          <div style="padding: 0.13rem">
            ...
            <div style="float:right;margin-right:20px;">
                <el-input placeholder="请输入要查找的设备名称" v-model="searchFile" style="width:300px;margin-right:10px;"></el-input><el-button type="primary" @click="searchFileByName" >搜索</el-button><el-button type="primary" style="margin-left:5px;" @click="resetAll" >重置</el-button>
            </div>
          </div>
